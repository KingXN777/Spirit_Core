...
local Window = Rayfield:CreateWindow({
   Name = "[🔮𝚂𝙿𝙸𝚁𝙸𝚃 𝙷𝚄𝙱🔮] | Steal A Brainrot [Beta Version]",
   Icon = 11151804229,
   LoadingTitle = "Steal A Brainrot Script Script [Beta Verison] @Kingosxzim",
   LoadingSubtitle = "Join Telegram Spirit Hub Community",
   Theme = "DarkBlue",
   DisableRayfieldPrompts = false,
   DisableBuildWarnings = false,
   ConfigurationSaving = {
      Enabled = true,
      FolderName = "SpiritHub",
      FileName = "SpiritBeta"
   },
   Telegram = {
      Enabled = true,
      Invite = "d4grwUvPmy1lOTI0",
      RememberJoins = true
   },
   KeySystem = False,
   KeySettings = {
...
text.Text = "https://t.me/+d4grwUvPmy1lOTI0"
...
- Join Telegram Spirit Hub Community
    ]]
})
...
local Button = Tab:CreateButton({
   ...
   Callback = function()
      -- Ganti link di sini dengan link Telegram kamu
      setclipboard("https://t.me/+d4grwUvPmy1lOTI0")
